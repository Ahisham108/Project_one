...
def get_filters():
    ...
    if filter == 'month' or filter == 'both':
        ...
        while month not in months:
            print('"Sorry, your input should be: january, february, march, april, may, june')
            month = input('Which month - January, February, March, April, May, or June? ').lower()
    else:
        month = 'all'
    ...
    if filter == 'day' or filter == 'both':
        ...
        while day not in days:
            print('Please input day of week: ')
            day = input('Which day - Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, or Sunday? ').title()
    else:
        day = 'all'
...
def trip_duration_stats(df):
    ...
    print('Average travel time is: ', average_travel_duration)
